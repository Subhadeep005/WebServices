 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://impl.endpoint.javatech.codingraja.com/", wsdlLocation = "http://localhost:1234/ws/helloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://impl.endpoint.javatech.codingraja.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1234/ws/helloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://impl.endpoint.javatech.codingraja.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.endpoint.javatech.codingraja.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
