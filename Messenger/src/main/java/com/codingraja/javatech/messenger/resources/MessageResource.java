package com.codingraja.javatech.messenger.resources;
...
import com.codingraja.javatech.messenger.resources.beans.MessageFilterBean;
import com.codingraja.javatech.messenger.service.MessageService;
...
public class MessageResource {
	...
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public List<Message> getAllJsonMessages(@BeanParam MessageFilterBean filterBean) {
	...
	public List<Message> getAllXmlMessages(@BeanParam MessageFilterBean filterBean) {
	...
	public Response addMessage(Message message, @Context UriInfo uriInfo) {
		...
		// return Response.created(new URI("/messenger/rest/messages" +
